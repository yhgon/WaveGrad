...
use custom build docker images `docker pull hryu/pytorch:20.08-3 ` which based on `nvcr.io/nvidia/pytorch:20.08-py3` with `torchaudio` source build, `matplotlib=3.2.2` , `apex` source build and `sox`.
