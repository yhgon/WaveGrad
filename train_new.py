    ...
    for epoch in range(start_epoch, args.epochs + 1):
        ...
        for i,batch in enumerate(train_loader):
           ...
           #     raise Exception("loss is NaN") 
            ...
            if local_rank == 0:
                print("\nepoch {:4d} | iter {:>12d}  {:>3d}/{:3d} | {:3.2f}s/iter est {:4.2f}s/epoch | losses {:>12.6f} {:>12.6f} LR {:e}--> {:e}".format(
                               epoch, iteration,      i, iter_size, dur_iter,      dur_epoch_est, iter_loss, grad_norm, old_lr, new_lr  ) ,end='' )
            iter_loss =0
            iteration += 1
